...
- `组图 23.md`：Ref-A / Ref-B 到 Target 的差异迁移规则；当前 v1.7.10.6 为压缩结构版，保留 List 1 人物贴邻热区互斥、List 2 冷区兜底与新增物体空间可放置性约束。
...
- `组图 23.md` 的 List 2 每块预留冷区都要先尝试已有独立小物或局部承载面兜底；例如桌侧面、抽屉面、墙面小块可做贴纸、标记、小缺口、小裂纹或局部图案替换。
