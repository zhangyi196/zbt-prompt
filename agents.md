...
- `Game content extraction/data/agents.md`、`Game content extraction/data/审查规则.md`、`Game content extraction/data/审查文件.md`、`Game content extraction/data/修改规则.md`：盲盒四池写库、内容审查记录和审查后替换细则，改 `blind_boxes.py` 前先读。
...
- 修改盲盒物品库时先用 `Game content extraction/data/审查规则.md` 发现问题并写入 `Game content extraction/data/审查文件.md`，再按 `Game content extraction/data/修改规则.md` 读取审查文件后替换；替换必须解决视觉本体重复、场景常识错位和同模板凑数的根因。
